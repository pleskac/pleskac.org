...
const ResumeDetail = (props: {
  ...
  >
    ...
    <span className={css({fontWeight: '700', fontSize: '20px'})}>{props.title}</span>
    {props.subdetails && (
      <ul>
        {props.subdetails.map((team, index) => (
          ...
          >
            ...
            <p className={css({color: 'text.raised'})}>{team.description}</p>
          </li>
        ))}
      </ul>
    )}
      ...
      >
        ...
        >
          <div>
            ...
            />
            <ResumeHeader icon={<Microsoft />} title="Microsoft" />
            <ResumeDetail
              dates="2013 - 2018"
